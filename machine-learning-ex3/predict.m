...
% Implement the feedforward propagation algorithm of neural network
...
Z2 = Theta2 * A2';          % Z2 (10 * 5000), aka (number of labels x m)

[~, p] = max(sigmoid(Z2'), [], 2);    % Get the index of maximum value
